...
//     return <div>Loading...</div>; // اجعلها رسالة انتظار أو شيء آخر
// }

  if (!mounted) return null;

  // const logoSrc = currentLanguageObj?.logoPath || null; // استخدم null إذا كانت القيمة فارغة
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="text-gray-200 min-w-[80px] text-left group-hover:text-white transition-colors">
          {currentLanguageObj?.label as string}
        </span>
